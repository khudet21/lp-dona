...
class PortfolioResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Karya (Portfolio)';
    protected static ?string $pluralModelLabel = 'Karya (Portfolio)';
    protected static ?string $navigationLabel = 'Karya / Portfolio';
